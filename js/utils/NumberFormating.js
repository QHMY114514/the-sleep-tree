...
function formatTime(s) {
    ...
    else return formatWhole(Math.floor(s / 31536000)) + "年 " + formatWhole(Math.floor(s / 86400) % 365) + "天 " + formatWhole(Math.floor(s / 3600) % 24) + "分 " + formatWhole(Math.floor(s / 60) % 60) + "秒 " + format(s % 60) + "s"
}
